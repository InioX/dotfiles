# Generated by Powerlevel10k configuration wizard on 2022-11-07 at 18:43 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND="#362f2b"
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND="#ffbf9b"
  ...
  function my_git_formatter() {
    ...
    # in the repofor i in {0..255}; do print -Pn “%K{$i} %k%F{$i}${(l:3::0:)i}%f “ ${${(M)$((i%6)):#3}:+$’\n’}; donefor i in {0..255}; do print -Pn “%K{$i} %k%F{$i}${(l:3::0:)i}%f “ ${${(M)$((i%6)):#3}:+$’\n’}; donefor i in {0..255}; do print -Pn “%K{$i} %k%F{$i}${(l:3::0:)i}%f “ ${${(M)$((i%6)):#3}:+$’\n’}; donefor i in {0..255}; do print -Pn “%K{$i} %k%F{$i}${(l:3::0:)i}%f “ ${${(M)$((i%6)):#3}:+$’\n’}; donefor i in {0..255}; do print -Pn “%K{$i} %k%F{$i}${(l:3::0:)i}%f “ ${${(M)$((i%6)):#3}:+$’\n’}; donefor i in {0..255}; do print -Pn “%K{$i} %k%F{$i}${(l:3::0:)i}%f “ ${${(M)$((i%6)):#3}:+$’\n’}; donefor i in {0..255}; do print -Pn “%K{$i} %k%F{$i}${(l:3::0:)i}%f “ ${${(M)$((i%6)):#3}:+$’\n’}; donesitory config. The number of staged and untracked files may also be unknown
    # in this case.
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND="362f2b"
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND="362f2b"
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND="#362f2b"
